...
const TEXT_STYLES: { name: string; cls: string; spec: string; sample?: string }[] = [
  ...
  { name: "Heading / H2", cls: "font-display text-2xl font-extrabold", spec: "24/1.33 · 800 · −0.015em" },
  ...
  { name: "UI / Price", cls: "font-display text-2xl font-extrabold tabular", spec: "24/1.33 · 800 · tabular", sample: "€ 485.000" },
        ...
        <Section id="patterns" title="Search & card patterns"
          ...
          <div className="flex flex-col gap-6 rounded-xl border border-slate-300 bg-white p-5">
            ...
            <ul className="list-disc space-y-1 pl-5 text-xs text-muted">
              ...
              <li><strong>Mobile logo is mark-only</strong> (hotspot test 2026-07-29): the header renders <code>{"<Logo compact />"}</code> — the wordmark is hidden below <code>sm</code> because the full logo was the #1 predicted-attention hotspot on every mobile first view. The wrapping link keeps <code>aria-label="REVALO24 home"</code>; footer, drawer and agent sidebar keep the full logo.</li>
