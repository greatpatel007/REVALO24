...
export const PROPERTIES: Property[] = [
  prop({ id: 1, title: "3-room apartment with balcony", listingType: "buy", price: 485000, propertyType: "Apartment", livingArea: 86, rooms: 3, bedrooms: 2, bathrooms: 1, placement: "featured", yearBuilt: 1964, energyRating: "B", energyCertType: "demand", energyValue: 68.4, energySource: "Fernwärme", energyCertYear: 2023, floor: "3 of 5", location: { country: "Germany", countryCode: "DE", county: "Bavaria", city: "München", postalCode: "80804", street: "Schwabing", geo: { lat: 48.16, lng: 11.58 } } }),
  prop({ id: 2, title: "Riverside Residences · 14 units", listingType: "buy", price: 312000, propertyType: "New Construction", livingArea: 52, rooms: 2, bedrooms: 1, bathrooms: 1, placement: "top", isNewConstruction: true, energyRating: "A", agentId: 102, amenities: ["Balcony", "Elevator", "Parking", "Fitted kitchen"], location: { country: "Czechia", countryCode: "CZ", city: "Praha", postalCode: "186 00", street: "Karlín", geo: { lat: 50.09, lng: 14.45 } } }),
  ...
  prop({ id: 6, title: "Industrial loft near Alexanderplatz", listingType: "rent", price: 2100, propertyType: "Loft", livingArea: 84, rooms: 2, bedrooms: 1, bathrooms: 1, placement: "top", crmLinked: true, energyRating: "D", location: { country: "Germany", countryCode: "DE", city: "Berlin", postalCode: "10178", street: "Mitte", geo: { lat: 52.52, lng: 13.41 } } }),
  ...
  prop({ id: 9, title: "Penthouse · Salamanca district", listingType: "buy", price: 1150000, propertyType: "Penthouse", livingArea: 165, rooms: 5, bedrooms: 3, bathrooms: 3, placement: "featured", energyRating: "B", agentId: 103, amenities: ["AC", "Pool", "Elevator", "Parking"], location: { country: "Spain", countryCode: "ES", city: "Madrid", postalCode: "28006", street: "Salamanca", geo: { lat: 40.43, lng: -3.68 } } }),
...
export const INVOICES_BY_AGENT: Record<number, Invoice[]> = {
  101: [
    { id: "INV-2026-0107", date: "2026-07-01", description: "Professional plan — July 2026", amountEur: 149, vatRate: 19, reverseCharge: false, pdfUrl: "#" },
    { id: "INV-2026-0093", date: "2026-06-14", description: "Top placement · 30 days — Loft Berlin", amountEur: 99, vatRate: 19, reverseCharge: false, pdfUrl: "#" },
    { id: "INV-2026-0061", date: "2026-06-01", description: "Professional plan — June 2026", amountEur: 149, vatRate: 19, reverseCharge: false, pdfUrl: "#" },
  ],
  102: [
    { id: "INV-2026-0102", date: "2026-07-01", description: "Starter plan — July 2026", amountEur: 49, vatRate: 0, reverseCharge: true, pdfUrl: "#" },
    { id: "INV-2026-0071", date: "2026-06-01", description: "Starter plan — June 2026", amountEur: 49, vatRate: 0, reverseCharge: true, pdfUrl: "#" },
  ],
  108: [],
};
