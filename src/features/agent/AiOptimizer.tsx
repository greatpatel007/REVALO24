...
import { generateExpose, getSubscription } from "@/features/agent/api";
          ...
          {active && (
            <div className="space-y-5 p-6">
              ...
              <div className="flex flex-wrap gap-2 border-t border-slate-200 pt-5">
                {/* Hands the generated copy to a new listing draft (prefills title + description) */}
                <Button onClick={() => navigate(to("/agent/listings/new"), { state: { expose: { headline: active.headline, description: active.description } } })}>
                  {t("agent.ai.apply")}
                </Button>
